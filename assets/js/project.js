 ...
 * clicks on one of the icons, that technology become <i>selected</i>: the icon is colorized and the
 * text explaining the technology changes to match the clicked one.
 */
$(function () {
